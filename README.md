...
For the full build log — infrastructure, design decisions, and the reasoning behind them — see **[what_we_did.md](what_we_did.md)**. For a visual walkthrough of the whole story (including the flawed first benchmark and how it got fixed), open **[quax_presentation.html](quax_presentation.html)** in a browser, or you can just click on this: [quax presentation](https://amirh0ss3in.github.io/Presentations/quax_presentation_fixed.html) .
